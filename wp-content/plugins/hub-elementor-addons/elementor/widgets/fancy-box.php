...
class LD_Content_Box extends Widget_Base {
	...
	protected function render() {
		...
		switch($settings['template']){
			...
			<div class="lqd-fb-inner lqd-overlay" data-slideelement-onhover="true" data-slideelement-options='{ "visibleElement": "h6, <?php echo esc_attr($settings['title_tag'] ); ?>", "hiddenElement": ".lqd-fb-txt" }'>
			...
			<div class="lqd-fb-inner">
				...
				<div class="lqd-fb-content">
					<div class="lqd-fb-content-inner">
						...
						<?php
							if( !empty( $settings['title'] ) ) {
								printf('<div class="lqd-fb-title mb-2"><%1$s class="lqd-fb__title mt-0 mb-0 %2$s">%3$s<i class="lqd-icn-ess icon-ion-ios-arrow-forward"></i></%1$s></div>', $settings['title_tag'], $settings['tag_to_inherite'], $settings['title'] );
							}
						?>
