			...
			<div class="ld-flipbox-wrap w-100 pos-rel transform-style-3d">
				<?php 
					...
					printf(
						...
						'front-' . $this->get_id(), 
						($front_content_type === 'front_tinymce' ? $front_content : \Elementor\Plugin::instance()->frontend->get_builder_content_for_display( $front_templates ))
					);
					...
					printf(
						...
						'back-' . $this->get_id(), 
						($back_content_type === 'back_tinymce' ? $back_content : \Elementor\Plugin::instance()->frontend->get_builder_content_for_display( $back_templates ))
					);
