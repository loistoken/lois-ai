	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'selectors' => [
					'{{WRAPPER}} .lqd-text-reveal-el:not(.split-text-applied), {{WRAPPER}}.lqd-text-reveal-el figure' => 'opacity: {{SIZE}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'edges' => esc_html__( 'Rdges', 'hub-elementor-addons' ),
	...
	protected function render() {
		...
		$this->add_render_attribute(
			...
			[
				...
				'data-parallax' => 'true',
				'data-parallax-options' =>  wp_json_encode( array( 'parallaxTargets' => '.lqd-chars, figure', 'start' => $startTrigger, 'end' => $endTrigger, 'scrub' => 3 ) ),
