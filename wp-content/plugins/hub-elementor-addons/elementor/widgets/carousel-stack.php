...
class LD_Carousel_Stack extends Widget_Base {
	...
	protected function render() {
		...
		?>
		<div id="<?php echo esc_attr( 'lqd-carousel-stack-' . $this->get_id() ) ?>" class="carousel-container lqd-carousel-stack pos-rel">
				...
				<?php
					...
					if ( $settings['list'] ) {
						foreach (  $settings['list'] as $item ) {
							...
							$item['content_type'] === 'tinymce' ? $item['list_content'] : \Elementor\Plugin::instance()->frontend->get_builder_content_for_display( $item['templates'] ) );
