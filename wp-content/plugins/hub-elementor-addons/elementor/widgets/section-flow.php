...
class LD_Section_Flow extends Widget_Base {
	...
	protected function get_flow_section_content( $item, $col ) {
		...
		if ( $item[ $col . '_content' ] === 'image' ){
			...
			echo Plugin::instance()->frontend->get_builder_content_for_display( $item[ $col . '_template' ] );
		}
	...
	protected function render() {
		...
		<div class="lqd-section-flow flex-wrap" data-lqd-section-flow="true">
			<div class="lqd-section-flow-panel lqd-section-flow-panel-start col-md-6 ps-0 pe-0">
			...
			<div class="lqd-section-flow-panel lqd-section-flow-panel-end col-md-6 ps-0 pe-0">
				<?php foreach( $settings['items'] as $item ) : ?>
