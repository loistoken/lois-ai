	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Enter categories, tags or custom taxonomies.', 'hub-elementor-addons' ),
			...
			echo '<div class="lqd-pf-grid">';
				...
				if( in_array( $settings['pagination'], array( 'ajax' ) ) && $url = get_next_posts_page_link( $GLOBALS['wp_query']->max_num_pages ) ) {
					...
					switch( $settings['pagination'] ) {
						...
						case 'ajax':
							$ajax_text = ! empty( $settings['ajax_text'] ) ? esc_html( $settings['ajax_text'] ) : esc_html__( 'Load more', 'landinghub-core' );
