<main>
	...
	<div class="lqd-row">
		<img src="<?php echo esc_url(get_template_directory_uri() . '/liquid/assets/img/dashboard/about/3.jpg'); ?>"  
	...
	<div class="lqd-row lqd-about-iconbox-wrap">
		<div class="lqd-col-4 lqd-about-iconbox">
			<h4>Introducing v3</h4>
			<p>Hub v3 is a major update for Elementor</p>
			<a href="https://landing-3.liquid-themes.com/" target="_blank" class="merlin__button">
