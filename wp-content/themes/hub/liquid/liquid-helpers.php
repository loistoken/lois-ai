...
class Liquid_Helper {
	...
	public function get_elementor_page_settings( $option_id ){

		if ( (!class_exists( 'Liquid_Elementor_Addons' ) && !defined( 'ELEMENTOR_VERSION' )) || empty( $post_id ) ){
			//return;
		}

		$page_settings_manager = \Elementor\Core\Settings\Manager::get_settings_managers( 'page' );
		$page_settings_model = $page_settings_manager->get_model( 36 );
		return $page_settings_model->get_settings( $option_id );
